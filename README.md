...
* pytest（282 项：281 passed + 1 skipped，其中 19 项为 FastAPI TestClient 接口级集成测试）
...
│   └── tests/                   # pytest 测试（282 项：281 passed + 1 skipped）
...
当前收集 282 项：281 项通过，1 项因缺少 GDAL 环境被跳过；其中 19 项为 FastAPI TestClient 发起的接口级集成测试。
