...
> 更新时间：2026-07-03（新增 Function Calling 工具系统）
...
- **AI 工具系统（Function Calling）** — AI 可以调用 Python 工具：
  - `fetch_webpage` — 获取网页内容，支持国内可访问网站
  - `save_file` — 保存 CSV/GeoJSON 等文件到服务器
  - **多步循环** — AI 自动规划多步操作（先抓网页、再分析、再保存文件）
...
- [x] AI 工具系统（Function Calling）— AI 直接操作数据，抓网页、存文件
- [ ] 文件下载 — 前端下载 AI 生成的文件
- [ ] 多图层叠加分析
- [ ] 属性表查看与编辑
- [ ] 坐标系投影转换
